...
//		dao.delete("HT00000002");
		...
		//單一查詢
//		HouseTrackVO houTraVO3 = dao.findByPrimaryKey("HT00000002");
...
//		System.out.println(houTraVO3.getHou_tra_status());
		...
		//查詢全部
//		List<HouseTrackVO> list = dao.getAll();
//		for(HouseTrackVO aHouseTrackVO :list) {
