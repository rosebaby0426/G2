...
public class Good_ordDAO implements Good_ordDAO_interface{
	...
	private static final String UPDATE = 
			"UPDATE GOOD_ORD SET mem_id=?, good_ord_dat=?, good_ord_sta=?, good_ord_nam=? ,good_ord_add=? "
			+ "WHERE good_ord_id = ?";
	@Override
	...
	public void update(Good_ordVO good_ordVO) {
		...
		try {
			...
			pstmt.setString(4, good_ordVO.getGood_ord_nam());
			pstmt.setString(5, good_ordVO.getGood_ord_add());
			pstmt.setString(6, good_ordVO.getGood_ord_id());
